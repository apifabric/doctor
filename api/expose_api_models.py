...
def expose_models(api, method_decorators = []): 
    ...
    api.expose_object(database.models.LabTest, method_decorators= method_decorators)
    api.expose_object(database.models.MedicalRecord, method_decorators= method_decorators)
    api.expose_object(database.models.Nurse, method_decorators= method_decorators)
